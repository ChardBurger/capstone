<nav class="navbar navbar-inverse bg-primary navbar navbar-fixed-top" style="background-color: #8F2831" >
  <div class="container-fluid">
    ...
    <a class="navbar-brand hvr-grow" href="index.php" style="color:white">HOME</a>
	  <a class="navbar-brand hvr-grow" href="aboutus.php"style="color:white">ABOUT</a>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <form id="signin" class="navbar-form navbar-right" role="form"style="margin-right:10px" method="post" >
                        ...
                        <button type="submit" style="color:white; background-color:#3D577A ;" class="btn" name="login_button">Login</button>
                   </form>
