...
<body style="background-image:url(images/images/11.png); background-size: 100% auto; background-attachment: fixed">
<?php include 'includes/inc_header_nav_night.php' ?>
